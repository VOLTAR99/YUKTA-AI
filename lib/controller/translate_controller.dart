...
class TranslateController extends GetxController {
  ...
  Future<void> translate() async {
    if (textC.text.trim().isNotEmpty && to.isNotEmpty) {
      ...
      if (from.isNotEmpty) {
        prompt =
            'Directly translate the given text from ${from.value} to ${to.value}:\n${textC.text}';
      } else {
        prompt = 'Directtly translate the given text to ${to.value}:\n${textC.text}';
      }
      ...
      if (to.isEmpty) MyDialog.info('Please select a language to translate...');
      if (textC.text.isEmpty) {
        MyDialog.info('Please enter something to translate...');
      }
    }
  }
